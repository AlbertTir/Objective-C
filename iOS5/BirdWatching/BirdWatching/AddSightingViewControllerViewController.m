...
//
// this is to allow the addition of new birds
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    //i think what this means might be when this add scene loads, the first textfield won't automatically trigger the keyboard
